...
In 1716, Vivaldi published a set of concertos which he had composed a few years earlier in 1712–13. Published as {{% resource_link "59196d33-3bb3-468c-a0bb-bf5b20f18131" "his Opus 4 and subtitled \"La stravaganza\"" %}} (Extravagance or Eccentricity), this collection features twelve concertos for solo violin.
...
Recording performed by The English Concert, Simon Standage (soloist), directed by Trevor Pinnock. {{% resource_link "5af7e7a9-c18b-4e01-984d-9989295a6225" "[Listen on YouTube]" %}}
...
These concertos have been quoted and used in a variety of subsequent works throughout the centuries, reinforcing their enduring popularity. As early as 1726 (just a year after the publication of the Four Seasons), J.S. Bach used a theme from the first movement of the Spring concerto (Op. 8 No. 1) in an aria in his cantata, *Wer weiß, wie nahe mir mein Ende?* BWV 27 {{% resource_link "5517e6c1-45ab-4b91-86af-4dd519f7ff1d" "[Listen on YouTube" %}}). In more recent years, these pieces have been quoted or used in soundtracks for TV and film, as well as samples in pop music recordings. Some brief examples include The Piano Guys 2014 mashup of the Winter concerto with the song “Let It Go” from Frozen {{% resource_link "5d433890-2e48-476c-8c79-5f8822553a97" "[Listen on YouTube]" %}}, as well as rapper Lupe Fiasco’s 2015 album *Tetsuo & Youth* which samples all four concertos on tracks mixed with samples of sounds associated with those seasons (for instance, the sound of children playing in a pool or maybe at a beach for Summer, {{% resource_link "6a251961-33f6-4427-a555-cc8b215df84e" "[Listen on YouTube]" %}}. Finally, the Winter concerto is played by the character Wednesday from the 2022 TV show of the same name in a version for solo cello {{% resource_link "7ca680d4-8fde-4100-b436-f62e0cc4c15f" "[Listen on YouTube]" %}}.
...
The manuscript copy sent to the Margrave is an interesting artifact in its own right. It contains a written dedication message which extols the Margrave’s generosity and good musical taste. While Bach does not directly ask for a job (that would be a major faux pas), it is possible that such a request is the subtext of this dedication. {{% resource_link "dbdb782f-7e48-40e3-ad19-941239cda6a6" "The title page to this manuscript is reproduced in this image" %}}.
...
Recording performed by the Freiburger Barockorchester. {{% resource_link "88a5dc5f-e778-45cb-b586-4af7190109ab" "[Listen on YouTube]" %}}
